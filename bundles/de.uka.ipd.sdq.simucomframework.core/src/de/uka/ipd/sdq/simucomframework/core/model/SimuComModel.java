/** */
package de.uka.ipd.sdq.simucomframework.core.model;
...
public class SimuComModel extends SchedulerModel {
    ...
    /**
     * Creates a new SimuComModel. ProbeFrameworkContext and ResourceRegistry are created as part of
     * this constructor.
     * 
    ...
    public SimuComModel(final SimuComConfig config, final SimuComStatus status, final ISimEngineFactory factory,
        ...
        // Initializing the ProbeFrameworkContext in case it was not provided (legacy behavior of
        // SimuCom)
    ...
    private ProbeFrameworkContext initialiseProbeFramework() {
        ...
        final ProbeFrameworkContext result = new ProbeFrameworkContext(
                new RecorderAttachingCalculatorFactoryDecorator(new ExtensibleCalculatorFactoryDelegatingFactory(),
                        this.config.getRecorderName(), this.config.getRecorderConfigurationFactory()));
                    ...
                    if (notification.getEventType() == Notification.SET) {
                        if (notification.getFeature() == SimucomstatusPackage.eINSTANCE.getProcess_CurrentAction()) {
                            ...
                            if (LOGGER.isDebugEnabled()) {
                                LOGGER.debug("Process " + p.getId() + " changed currentAction to " + a.getClass()
                                    .getName());
                            }
                        }
    ...
    public void finalise() {
        ...
        if (LOGGER.isEnabledFor(Level.INFO)) {
            LOGGER
                .info("Simulation took " + getSimulationControl().getCurrentSimulationTime() + " simulated time units");
        }
